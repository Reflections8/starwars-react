...
import game1Icon from "./ChooseGame/img/game1.svg";
import game1Bg from "./ChooseGame/img/game1-bg.png";
import game2Icon from "./ChooseGame/img/game2.svg";
import game2Bg from "./ChooseGame/img/game2-bg.png";
import "./ChooseGame/styles/chooseGame.css";
  ...
  return (
    <div className="chooseGame">
      ...
      <div className="chooseGame__game">
        ...
        <CuttedButton text="Играть" size="small" callback={() => {
			openGame('/game2')
		  }} />
      </div>
    </div>
