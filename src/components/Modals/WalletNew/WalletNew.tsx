...
import { SelectOptionType } from "../Settings/types.ts";
...
import exchangeIcon from "./img/exchange-icon.svg";
import withdrawalIcon from "./img/withdrawal-icon.svg";
  ...
  return (
    <>
      <div className="wallet modal__scrollContainer">
        ...
        <div className="walletNew__container">
          <CuttedButton
            iconSrc={depositIcon}
            text={t("walletModal.deposit")}
            className="walletNew__container-btn"
            callback={(e) => {
              e.stopPropagation();
            }}
          />
          ...
          />
          <CuttedButton
            iconSrc={withdrawalIcon}
            text={t("walletModal.withdrawal")}
            className="walletNew__container-btn"
            callback={(e) => {
              e.stopPropagation();
            }}
